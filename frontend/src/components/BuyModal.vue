  ...
  <BaseModal @close="close">
    ...
    <div class="content bg-white px-5">
      ...
      <div v-show="step == 1">
          ...
          <div class="flex-1 bg-teal-light p-6 w-full rounded-sm shadow-md">
            <h5 class="text-white">
              <span class="font-bold">
                Your Bet -
              </span>Arsenal to win the Premiere League <br>
              <span class="">
                Match Date:
              </span>19:00 GMT November 2018
            </h5>
          </div>
        </div>
        ...
        <p class="flex-1 bg-yellow-light p-3 my-5 shadow">
          Please note: Your current daily limit is $800. <router-link to="/home">
            Read more here
          </router-link> 
        </p>
    ...
    <div v-show="step == 2">
      <div class="text-center mb-16">
        ...
        <p class="text-lg">
          Your confirmation number is 000121343FD
        </p>
      </div>
